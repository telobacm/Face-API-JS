...
const subunitSeed: Prisma.SubunitUncheckedCreateInput[] = [
  ...
  { position: 'DOSEN', name: 'Departemen Pendidikan Bahasa dan Sastra Indonesia' },
  ...
  { position: 'DOSEN', name: 'Departemen Pendidikan Teknik Elektronika dan Informatika' },
  { position: 'DOSEN', name: 'Departemen Pendidikan Teknik Mesin' },
  { position: 'DOSEN', name: 'Departemen Pendidikan Teknik Otomotif' },
  { position: 'DOSEN', name: 'Departemen Pendidikan Teknik Sipil dan Perencanaan' },
